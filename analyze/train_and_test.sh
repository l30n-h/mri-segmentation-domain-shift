...
do
  ...
  do
    ...
    python code/nnUNet/nnunet/run/run_training.py 2d nnUNetTrainerV2_${trainer} Task601_cc359_all_training ${fold_i}
    ...
    do
      ...
      {
        testout_dir="data/testout/${trainer}-ep${epoch}-${fold_name}"
        mkdir ${testout_dir}
